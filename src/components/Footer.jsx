...
const Footer = () => {
  return (
    <div id="Contact" className="mt-8 bg-[#0f041cff] pt-9">
      {
        <div className="mt-8 bg-[#0f041cff]  pt-9">
          <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
            <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
              <div className="md:w-[316px]">
                <p className="text-[18px] font-medium text-white"></p>
                <h1 className="text-white font-extrabold">
                  <span className="text-rose-600">Talent</span>Traveler
                </h1>
                <p />
                <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
                  Connecting students with the right talent on campus. Hire.
                  Collaborate. Grow.
                </p>
                ...
                <div className="mt-[23px] flex">
                  ...
                  <div className="ml-[18px]">
                    <a
                      ...
                      className="font-Inter text-[14px] font-medium text-[#fff]"
                    >
                      shivaji nagar, Pune, India, 411003
                    </a>
                    <p className="font-Inter text-[12px] font-medium text-white">
                      Address
                    </p>
            ...
            <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
              <p className="text-[10px] font-normal text-white md:text-[12px]">
                © Copyright
                {/* */}2024
                {/* */}, All Rights Reserved by Talent Traveler. PVT. LTD
              </p>
            </div>
          </div>
        </div>
